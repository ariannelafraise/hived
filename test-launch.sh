.venv/bin/python hivesec.py -s <<EOF
...
type=PATH msg=audit(1766092657.249:131): item=0 name="/etc/shadow" inode=10886263 dev=103:06 mode=0100644 ouid=0 ogid=0 rdev=00:00 nametype=NORMAL cap_fp=0 cap_fi=0 cap_fe=0 cap_fver=0 cap_frootid=0
